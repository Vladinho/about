...
/******/ 	var hotCurrentHash = "d29287b0eb0af7076b68"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	  var $textarea = (0, _jquery2.default)('.js-about-input');
	
	  $textarea.text($textarea.text().replace(/\s\s/g, '')); // фиг знает откуда они там берутся...
	  $textarea.on('keyup', function (event) {
	    return textAreaAdjust(event.target);
	  });
	  setTimeout(function () {
	    return textAreaAdjust($textarea.get(0));
	  }, 0);
	});
	...
	//            {elementToDrag.style.left = "145px"}
	//            if((e.clientX - deltaX)<565 && (e.clientX - deltaX)>255)
	//            {elementToDrag.style.left = "370px"}
	//            if((e.clientX - deltaX)<765 && (e.clientX - deltaX)>565)
	//            {elementToDrag.style.left = "764px"}
	//
